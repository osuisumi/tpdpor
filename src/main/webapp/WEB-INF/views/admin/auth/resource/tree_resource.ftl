...
<@lo.layout jsArray=jsArray>
	...
	function beforeEditName(treeId, treeNode) {
	    ...
	    mylayerFn.open({
	            ...
	            type: 2,
	            title: '修改权限资源',
	            content: '${ctx}/admin/auth_resources/'+treeNode.id+"/edit",
				area: [600,600],
	            zIndex: 19999
	        });
	...
	function beforeRemove(treeId, treeNode) {
	    ...
	    if(treeNode.isParent){
	    	...
	    	confirm("确认删除 " + treeNode.name + " 吗？",function(){
	    		$.ajaxDelete("${ctx}/admin/auth_resources/"+treeNode.id,"",function(data){
	...
	function addHoverDom(treeId, treeNode) {
	    ...
	    if (btn) btn.bind("click", function(){
	        ...
	        mylayerFn.open({
	            ...
	            type: 2,
	            title: '新增权限资源',
	            content: '${ctx}/admin/auth_resources/create?pid='+treeNode.id,
				area: [600,600],
	            zIndex: 19999
	        });
	        return false;
